                    ...
                    <div class="row">
                      ...
                      <?php
                          if(isset($_SESSION["user"])) {
                              echo '<button class="btn btn-black btn-lg py-3 btn-block" onclick="window.location=\''.BASE_PATH.'checkout\'"><strong>THANH TOÁN</strong></button>';
                          } else if(!isset($_SESSION["user"]))
                            {
                              echo '<p>Đăng kí tài khoản để mua hàng! <a href="'.BASE_PATH.'signin"> <strong>Đăng ký</strong> </a></p>';
                          }
                      ?>
